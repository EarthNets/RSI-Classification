...
latex_documents = [
    (master_doc, 'rsicls.tex', 'MMClassification Documentation', author,
     'manual'),
]
...
man_pages = [(master_doc, 'rsicls', 'MMClassification Documentation', [author],
              1)]
...
texinfo_documents = [
    (master_doc, 'rsicls', 'MMClassification Documentation', author, 'rsicls',
