...
[`CustomDataset`](https://mmclassification.readthedocs.io/en/latest/api/datasets.html#rsicls.datasets.CustomDataset).
...
[CustomDataset](https://github.com/open-mmlab/mmclassification/blob/master/rsicls/datasets/custom.py).
...
We can create a new dataset in `rsicls/datasets/filelist.py` to load the data.
...
And add this dataset class in `rsicls/datasets/__init__.py`
...
You may refer to [API reference](https://mmclassification.readthedocs.io/en/latest/api/datasets.html#rsicls.datasets.ClassBalancedDataset) for details.
