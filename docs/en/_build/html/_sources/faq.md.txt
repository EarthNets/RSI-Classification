...
- Do I need to reinstall rsicls after some code modifications?

  If you follow [the best practice](install.md) and install rsicls from source,
...
- How to develop with multiple MMClassification versions?
  ...
  folders, like rsicls-0.21, rsicls-0.23. When you run the train or test shell script,
  it will adopt the rsicls package in the current folder. And when you run other Python
