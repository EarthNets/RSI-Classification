...
In this case, install rsicls from source:
...
```shell
mim download rsicls --config resnet50_8xb32_in1k --dest .
```

**Step 2.** Verify the inference demo.

Option (a). If you install rsicls from source, just run the following command:
...
Option (b). If you install rsicls as a python package, open you python interpreter and copy&paste the following codes.

```python
from rsicls.apis import init_model, inference_model
