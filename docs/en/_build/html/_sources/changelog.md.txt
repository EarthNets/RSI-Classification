...
- \[Docs\] fix logo url link from mmocr to rsicls. ([#732](https://github.com/open-mmlab/mmclassification/pull/732))
...
- Provide dockerfile to build rsicls dev docker image.
...
- Support mim, welcome to use mim to manage your rsicls project. ([#376](https://github.com/open-mmlab/mmclassification/pull/376))
...
- Support to test mmdet inference with rsicls backbone. ([#343](https://github.com/open-mmlab/mmclassification/pull/343))
...
- Check mmcv version when importing rsicls to ensure compatibility. (#209)
...
- Support showing and saving painted results in `rsicls.apis.test` and `tools/test.py`, matching the behavior of other open-mmlab projects. (#162)
