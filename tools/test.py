...
from rsicls.apis import multi_gpu_test, single_gpu_test
from rsicls.datasets import build_dataloader, build_dataset
from rsicls.models import build_classifier
from rsicls.utils import get_root_logger, setup_multi_processes


def parse_args():
    parser = argparse.ArgumentParser(description='rsicls test model')
...
def main():
    ...
    if 'CLASSES' in checkpoint.get('meta', {}):
        ...
        from rsicls.datasets import ImageNet
