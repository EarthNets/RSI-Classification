...
from rsicls.core import visualization as vis
from rsicls.datasets.builder import PIPELINES, build_dataset, build_from_cfg
from rsicls.models.utils import to_2tuple
...
def parse_args():
    ...
    parser.add_argument(
        ...
        'in `rsicls.core.visualization.ImshowInfosContextManager.put_img_infos`'
    )
