...
class VisionTransformerMultiLabelClsHead(MultiLabelClsHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(VisionTransformerMultiLabelClsHead, self).__init__(
            loss=loss,init_cfg=init_cfg, *args, **kwargs)
    ...
    def init_weights(self):
        super(VisionTransformerMultiLabelClsHead, self).init_weights()
