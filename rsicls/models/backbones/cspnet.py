...
class CSPNet(BaseModule):
    ...
    Example:
        ...
        >>> import torch
        >>> import torch.nn as nn
        >>> from rsicls.models import CSPNet
        >>> from rsicls.models.backbones.resnet import Bottleneck
        >>>
...
class CSPDarkNet(CSPNet):
    ...
    Example:
        >>> from rsicls.models import CSPDarkNet
        >>> import torch
...
class CSPResNet(CSPNet):
    ...
    Args:
        ...
        init_cfg (dict or list[dict], optional): Initialization config dict.
            Default: None.
    Example:
        >>> from rsicls.models import CSPResNet
        >>> import torch
...
class CSPResNeXt(CSPResNet):
    ...
    Args:
        ...
        init_cfg (dict or list[dict], optional): Initialization config dict.
            Default: None.
    Example:
        >>> from rsicls.models import CSPResNeXt
        >>> import torch
