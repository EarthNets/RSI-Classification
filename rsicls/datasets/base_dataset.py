...
from rsicls.core.evaluation import precision_recall_f1, support
from rsicls.models.losses import accuracy
...
class BaseDataset(Dataset, metaclass=ABCMeta):
    ...
    Args:
        ...
        pipeline (list): a list of dict, where each element represents
            a operation defined in `rsicls.datasets.pipelines`
