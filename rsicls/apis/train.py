...
from rsicls.core import DistEvalHook, DistOptimizerHook, EvalHook
from rsicls.datasets import build_dataloader, build_dataset
from rsicls.utils import get_root_logger
...
def train_model(model,
    ...
    Args:
        ...
        dataset (:obj:`rsicls.datasets.BaseDataset` | List[BaseDataset]):
