...
from rsicls.datasets import BaseDataset, RepeatAugSampler, build_sampler
...
@patch('rsicls.datasets.samplers.repeat_aug.get_dist_info', return_value=(0, 1))
...
@patch('rsicls.datasets.samplers.repeat_aug.get_dist_info', return_value=(0, 2))
