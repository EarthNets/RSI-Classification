...
from rsicls.datasets import ImageNet, build_dataloader, build_dataset
from rsicls.datasets.dataset_wrappers import (ClassBalancedDataset,
...
class TestDataloaderBuilder():
    ...
    @patch('rsicls.datasets.builder.get_dist_info', return_value=(0, 1))
    ...
    @patch('rsicls.datasets.builder.get_dist_info', return_value=(1, 2))
